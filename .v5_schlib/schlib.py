    ...
    def __init__(self, filename, create=False):
        ...
        if create:
            ...
            if not os.path.isfile(self.filename):
                sys.stderr.write(
                    "DCM file '{filename}' does not exist\n".format(
    ...
    def __parse(self):
        ...
        for line in f.readlines():
            ...
            if line.startswith(Documentation.line_keys["start"]):
                ...
                self.components[name] = OrderedDict(
                    [
...
class Component(object):
    ...
    def __init__(self, data, comments, filename, documentation):
        ...
        for line in data:
            ...
            if line[0] == "DEF":
                ...
                self.drawOrdered = (
                    []
                )  # list of draw elements references, needed to preserve line ordering
    ...
    def isSmallComponentHeuristics(self):
        ...
        # main symbol outline.
        drawing = self.draw
        filled_rects = [rect for rect in drawing["rectangles"] if rect["fill"] == "f"]
...
class SchLib(object):
            ...
            if line.startswith("#"):
                ...
                if line.startswith("ENDDEF"):
                    ...
                    self.components.append(
                        Component(
                            component_data, comments, self.filename, self.documentation
                        )
                    )
                    comments = []
        f.close()
    ...
    def compareChecksum(self, otherlib):
        ...
        return (
            self.checksum == otherlib.checksum
            and self.documentation.checksum == otherlib.documentation.checksum
        )
    ...
    def save(self, filename=None):
        ...
        for component in components:
            ...
            for elem in component.drawOrdered:
                item = elem[1]
                keys_list = Component._DRAW_KEYS[
                    elem[0]
                ]  # 'A' -> keys of all properties of arc
                line = elem[0] + " "  # 'arcs' -> 'A'
                for k in keys_list:
                    if k == "points":
