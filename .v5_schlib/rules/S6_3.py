...
class Rule(KLCRule):
    ...
    def __init__(self, component):
        super(Rule, self).__init__(
            component, "Part meta-data is filled in as appropriate"
        )
    ...
    def check(self):
        ...
        if self.checkDocumentation(
            ...
            False,
            self.component.isGraphicSymbol() or self.component.isPowerSymbol(),
        ):
    ...
    def checkDocumentation(
        self, name, documentation, alias=False, isGraphicOrPowerSymbol=False
    ):
        ...
        if not documentation:
            ...
            or not documentation["keywords"]
            or not documentation["datasheet"]
        ):
