...
new_symbol.pins.append(Pin(number='1', name='GND', etype='passive', posx=-7.62, posy=2.54, length=5.08))
new_symbol.pins.append(Pin(number='2', name='PA2', etype='passive', posx=-5.08, posy=-2.54))
